...
VERSIÓN CORREGIDA v2 - Fix Plotly gridcolor + SQLite
"""
...
def load_data(uploaded_file):
    ...
    # Clasificar Solicitud si existe
...
def train_model_logic(df):
    """Pipeline de entrenamiento con Gradient Boosting"""
...
def grafico_barras_horizontal(df, x, y, titulo, color='#FF6B6B'):
    """Gráfico de barras horizontal atractivo - CORREGIDO sin gridcolor"""
...
def grafico_pie_categorias(df, categoria_col, titulo, colores=None):
    """Gráfico de pie con colores personalizados - CORREGIDO"""
