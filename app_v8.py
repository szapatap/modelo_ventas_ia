"""
APLICACIÓN STREAMLIT - Sales Intelligence Platform v6
Frontend profesional con Sidebar y tema oscuro
VERSIÓN FINAL v6 - BD SQLite COMPLETAMENTE RESUELTA
"""
...
# ==========================================
# GESTIÓN DE BD - v6 COMPLETAMENTE NUEVA
# ==========================================

DB_PATH = 'sales_app.db'

def init_db():
    """Inicializa la BD - VERSIÓN v6 ROBUSTA"""
    try:
        ...
        # Si BD es nueva, crear tabla predictions directamente
        if not db_exists:
            ...
            # Si BD existe, verificar tabla predictions
...
def save_prediction_db(user, client, zone, category_product, prob, label, recommendation):
    """Guarda predicción - v6 GARANTIZADO"""
    conn = None
    try:
...
def get_history(user_id=None, days=30):
    """Obtiene histórico de predicciones - v6"""
    try:
        conn = sqlite3.connect(DB_PATH)
        conn.row_factory = sqlite3.Row  # Para obtener columnas correctamente
